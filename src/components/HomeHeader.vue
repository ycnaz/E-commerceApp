...
<template>
    <section class="bg-rose-500 h-[600px] w-full relative flex justify-center">
        <div class="text-white w-1/2 h-full flex flex-col justify-center z-10 max-xl:w-min">
            <strong class="text-6xl text-white min-w-max max-md:text-5xl max-sm:text-4xl max-[380px]:text-3xl tracking-tight leading-[1.15]">Present your products<br> to millions</strong>
            <span class="text-xl max-[380px]:text-lg tracking-wide">And buy the best products from all over the world</span>
        </div>
