                ...
                <div class="h-96 w-1/2 bg-rose-500 rounded-xl text-white p-5 relative">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex flex-col grow items-center px-5">
                            ...
                            <span class="mt-auto mb-5 text-3xl">Total price: {{ exchangeStore.userPref ? changePrices(props.item.price) * productQuantity : props.item.price * productQuantity }}/{{ exchangeStore.userPref ? exchangeStore.userPref : 'USD' }}</span>
